...
if(isset($_POST["id"]))
{
    /* file_put_contents('index3.html',$_POST["id"].": ".$_POST["text"]); */
    ...
    <div class="cont-inicio">
        <div class="contain-imagen">
            <div class="contain-titulo">
                <h1 class="edit" id="title_s1">'.$data->{'title_s1'}.'</h1>
            </div>
            <img class="edit" src="./images/gggggg-min.jpg" alt="">
        </div>
        ...
        <div class="contain-tajetas">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <p class="fw-bold text-center edit" id="card1_tit_s1">'.$data->{'card1_tit_s1'}.'</p>
                    <p class="card-text edit">'.$data->{'card1_text_s1'}.'</p>
                </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <p class="fw-bold text-center edit" id="card2_tit_s1">'.$data->{'card2_tit_s1'}.'</p>
                    <p class="card-text edit" id="card2_text_s1">'.$data->{'card2_text_s1'}.'</p>
                </div>
            </div>
            <div class="card">
                <span class="icono-d"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                ...
                <div class="card-body">
                    <p class="fw-bold text-center edit" id="card3_tit_s1">'.$data->{'card3_tit_s1'}.'</p>
                    <p class="card-text edit" id="card3_text_s1" >'.$data->{'card3_text_s1'}.'</p>
                </div>
            </div>
            <div class="card">
                <span class="icono-d"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                ...
                <div class="card-body">
                    <p class="fw-bold text-center edit" id="card4_tit_s1">'.$data->{'card4_tit_s1'}.'</p>
                    <p class="card-text edit" id="card4_text_s1" >'.$data->{'card4_text_s1'}.'</p>
                </div>
            </div>
    ...
    <div class="cont-inicio-dos">
        ...
        <div class="cont-leterings">
            <div class="cont-leter-uno">
                <h2 class="edit">Historia de Viaje</h2>
                <p class="edit">Sample text. Click to select the text box. Click again or double click to start editing
                    the text.</p>
            </div>
            <div class="cont-leter-dos">
                <h1 class="edit" id="title_s2">'.$data->{'title_s2'}.'</h1>
            </div>
        </div>
    </div>
    <div class="con-inicio-tres">
        <img src="'.$data->{'imgcarr1_s3'}.'" alt="" srcset="" class="edit" id="imgcarr1_s3">
        <img src="'.$data->{'imgcarr2_s3'}.'" alt="" srcset="" class="edit" id="imgcarr2_s3">
        <img src="'.$data->{'imgcarr3_s3'}.'" alt="" srcset="" class="edit" id="imgcarr3_s3">
        <img src="'.$data->{'imgcarr4_s3'}.'" alt="" srcset="" class="edit" id="imgcarr4_s3">
    </div>
    <div class="con-inicio-cuatro">
        <div class="cont-img-cuatro">
            <div class="cuadro-cuatro">
                <div class="cont"><img class="edit" id="img2_s4" src="'.$data->{'img2_s4'}.'"></div>
                <div class="cont-dos"><img class="edit" id="img1_s4" src="'.$data->{'img1_s4'}.'" alt=""></div>
            </div>
        </div>
        <div class="leter-cuatro">
            <div class="con-titulo-cuatro">
                <h1 class="edit" id="title_s4">'.$data->{'title_s4'}.'</h1>
            </div>
            <div class="text-cuatro ">
                <p class="edit" id="text_s4">'.$data->{'text_s4'}.'</p>
            </div>
        </div>
    </div>
    <div class="cont-inicio-cinco" id="img1_s5" style="background: url('.$data->{'img1_s5'}.');">
        <div class="con-seccion-cinco">
            <div class="con-text-cinco">
                <h1 class="edit" id="title_s5">'.$data->{'title_s5'}.'</h1>
                <p class="edit" id="text_s5">
                '.$data->{'text_s5'}.'</p>
    ...
    <div class="cont-inicio-seis">
        <div class="cont-des-seis">
            <div class="conten-text-seis">
                <h1 class="edit" id="title_s6" >'.$data->{'title_s6'}.'</h1>
                <p class="edit"  id="text_s6">'.$data->{'text_s6'}.'</p>
                <button type="button">Leer mas</button>
            </div>
        </div>
        <div class="cont-imagen-seis">
            <img class="edit" id="img1_s6" src="'.$data->{'img1_s6'}.'" alt="" srcset="">
        ...
        <div class="con-seccion-siente">
            <div class="con-text-siente">
                <div class="cont-titulo-siente">
                    <h1>Contactanos</h1>
                    <p class="edit">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Eius consequatur,in
                        doloribus dolor repudiandae nulla cumque iusto</p>
                </div>
